...
export default function CardBlurredCard({
  src,
  coverImage,
  title,
  author,
  ...
  const handleSliderChange = (value: number | number[]) => {
    if (audioRef.current) {
      ...
      const newTime = (singleValue / 100) * audioRef.current.duration;
  ...
  return (
    <Card
      isBlurred
      className="border-none bg-background/50 dark:bg-default-100/50 max-w-[610px]"
      shadow="sm"
    >
      <CardBody>
